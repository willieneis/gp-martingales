...
class SimpleGp:
    ...
    def get_gp_post_params_list(self, x_list, hp=None, full_cov=True):
        ...
        # TODO:
        # If data is empty, return gp prior params mu and cov.
        # Else return the postmu and postcov below.
    ...
    def get_gp_prior_params_list(self, x_list, hp=None, full_cov=True):
    """
    Compute and return GP prior parameters for list of inputs x_list. Assumes GP has
    zero mean.
    """
        if hp is None:
            hp = self.sample_list[0]

        cov = kernel(x_list, x_list, hp.ls, hp.alpha)
        # TODO: generalize to non-zero mean.
    ...
    def get_gp_post_list(self, x_list):
        ...
        # TODO:
        # Have hp as function arg (default=None), and if None set to sample_list[0]?
        # If there is no data, get prior mu and cov instead of postmu and postcov.
        # Use the get_gp_post_params function above instead.
